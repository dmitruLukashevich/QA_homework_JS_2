...
users.forEach(buddies => {
    if(buddies.registrationDate === '09.10.2021'){
    console.log(buddies)}
    else if (buddies.registrationDate === '10.10.2021' ){
        console.log(buddies)
    }
}
    )
// users.forEach(tempBlock =>
//      {
//          console.log(tempBlock.registrationDate === '09.10.2021' || tempBlock.registrationDate ==='10.10.2021' ? console.log(tempBlock) : '')
//     }
//     )
